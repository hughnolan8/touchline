...
def _init():
    with connect() as c:
        ...
        CREATE TABLE IF NOT EXISTS player_match_stats(match_id TEXT REFERENCES matches(id),player_id TEXT REFERENCES players(id),team_id TEXT REFERENCES teams(id),starter INTEGER NOT NULL,minutes REAL NOT NULL,xg REAL NOT NULL,xa REAL NOT NULL,position TEXT NOT NULL DEFAULT '',PRIMARY KEY(match_id,player_id));
        ...
        CREATE TABLE IF NOT EXISTS bet_notifications(bet_id INTEGER PRIMARY KEY REFERENCES bets(id),status TEXT NOT NULL DEFAULT 'pending',attempts INTEGER NOT NULL DEFAULT 0,sent_at TEXT,last_error TEXT);
        ...
        CREATE TABLE IF NOT EXISTS bet_closing_lines(bet_id INTEGER PRIMARY KEY REFERENCES bets(id),quote_id INTEGER REFERENCES quotes(id),captured_at TEXT NOT NULL,odds REAL NOT NULL,bookmaker TEXT NOT NULL,quoted_at TEXT NOT NULL,clv REAL NOT NULL);
