...
def reset_simulation_data(connection):
    ...
    for table in ('bet_closing_lines', 'fixture_notifications', 'bet_notifications', 'decisions', 'model_evaluations', 'bets', 'predictions', 'models', 'fixture_odds_snapshots', 'quotes', 'lineup_snapshots', 'player_match_stats', 'player_aliases',
